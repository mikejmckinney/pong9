...
import { BALL_SIZE, BALL_SPEED, GAME_HEIGHT, SERVE_ANGLE_OFFSET_DEG, SERVE_DIRECTION_THRESHOLD } from '../config/constants';
...
export default class Ball extends Phaser.Physics.Arcade.Sprite {
    ...
    launch() {
        ...
        const angle = Phaser.Math.FloatBetween(-SERVE_ANGLE_OFFSET_DEG, SERVE_ANGLE_OFFSET_DEG);
