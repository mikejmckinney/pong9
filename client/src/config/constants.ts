import {
    ...
    SERVE_ANGLE_HALF_RANGE_DEG as SHARED_SERVE_ANGLE_HALF_RANGE_DEG,
    SERVE_ANGLE_RANGE_DEG as SHARED_SERVE_ANGLE_RANGE_DEG,
    SERVE_DIRECTION_THRESHOLD as SHARED_SERVE_DIRECTION_THRESHOLD,
...
export const SERVE_DIRECTION_THRESHOLD = SHARED_SERVE_DIRECTION_THRESHOLD;
export const SERVE_ANGLE_RANGE_DEG = SHARED_SERVE_ANGLE_RANGE_DEG;
export const SERVE_ANGLE_HALF_RANGE_DEG = SHARED_SERVE_ANGLE_HALF_RANGE_DEG;
